...
function preload(){
  ...
  botones= loadStrings('/assets/botones.txt');
  cueva= loadImage('assets/cueva.png');
  marcas= loadImage('assets/marcas.png');
  luciernagas= loadImage('assets/luciernagas.png');
...
function mousePressed(){
  ...
  if (estado==9 && botonPresionado(275, 400, 100, 40)){
    estado==10;
    return;
